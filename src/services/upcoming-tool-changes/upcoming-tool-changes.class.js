...
exports.UpcomingToolChanges = class UpcomingToolChanges {
  constructor(options) {
  ...
  async create(data, params) {
    ...
    try {
      ...
      const resultSet = await conn.query(
        "call CreateUpcomingToolChanges(?,?,@recordCount,@returnValue); select @recordCount as recordCount, @returnValue as returnValue",
        [data.Building_Key, data.table]
      );
